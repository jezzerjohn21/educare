              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Dealer/Distributor Account (Agent Approval)</h4>
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Pending' order by lastname asc")or die(mysqli_error());
