            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  data-feather="plus"></i>Add Rewards</font></button>
 ...
 <td><?php echo $row['name']?></td>
  <td><?php echo $row['percentage']?></td>
                                      <td><?php echo $row['type']?></td>                               <td><?php echo $row['expiration']?></td>                                                       	   <td>
                                       	       <a href="edit_rewards.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Edit</font></a></td>
                                                                                                                          	   <td>
                                       	       <a href="delete_rewards.php?id=<?php echo $row['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="white">Delete</font></a></td>                                        	                                          	   
...
$type=$_POST['type'];
$exp=$_POST['exp'];
	$query21a1=mysqli_query($con,"select * from  rewards where name='$invoice' ")or die(mysqli_error());
...
$ses=$_SESSION['id'];
		  ...
		  mysqli_query($con,"INSERT INTO rewards(expiration,name,percentage,type) VALUES('$exp','$invoice','$percentage','$type')")or die(mysqli_error($con));
...
swal("Ops!", "Rewards Name Already Exists!", "warning");
