              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Distributor Account (Pending)</h4>
                    <div class="b">
...
$id_n=$rowuser['id_number'];
$region=$rowuser['region'];
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Pending' and account_type='Distributor' and region='$region' order by lastname asc")or die(mysqli_error());
                            ...
                            <td><?php echo $count?></td>
                                ...
                                <td><?php echo $row['account_type']?></td>
                                   ...
                                   ?>                                                                 
                                                                                            ...
                                                                                            <td><?php echo $row['approve_agent']?></td>                                                    
                                                                                                                            	   <td>
                                 	       
                                                        
                                                                                                                            	       <a href="edit_salesc2.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Update</font></a></td>
