              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Distributor Account (Admin Rejected)</h4>
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_admin='Rejected' and account_type='Distributor' order by lastname asc")or die(mysqli_error());
