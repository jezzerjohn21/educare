              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Distributor Account (Rejected Application)</h4>
                    <div class="b">
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Reject' and sponsor_id='$id_n' and account_type='Distributor'  and region='$region' order by lastname asc")or die(mysqli_error());
                                   ...
                                   ?>                                                                 
                                                                                            ...
                                                                                            <td><?php echo $row['approve_agent']?></td>                                                                     <td><?php echo $row['approve_admin']?></td>                                                                     
                                                                                                                            	   <td>
                                                                                                                            	       ...
                                                                                                                            	       <a href="edit_salesc.php?id=<?php echo $row['id'];?>" class="btn btn-success">Update</a></td>
