...
include('../dist/dbcon.php');
	...
	$date = date("Y-m-d H:i:s");
	$id=$_SESSION['id'];
	$remarks="Mobile Application-Logged out the system";  

	$date = date("Y-m-d H:i:s");
	 $ip = $_SERVER['HTTP_CLIENT_IP'] ? $_SERVER['HTTP_CLIENT_IP'] : ($_SERVER['HTTP_X_FORWARDED_FOR'] ? $_SERVER['HTTP_X_FORWARDED_FOR'] : $_SERVER['REMOTE_ADDR']);
	 	mysqli_query($con,"INSERT INTO history_log(ip_add,user_id,remarks,date_added) VALUES('$ip','$id','$remarks','$date')")or die(mysqli_error($con));
	session_destroy();
	
 echo '<meta http-equiv="refresh" content="2;url=../index_app.php">';
