...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Approved' and approve_admin='Approved' and account_type='Dealer' order by lastname asc")or die(mysqli_error());
                            ...
                            <td><?php echo $count?></td>
                              ...
                              <td><?php echo $row['id_number']?></td>
                                      ...
                                      <td><?php echo strtoupper($row['lastname'])?>, <?php echo strtoupper($row['firstname'])?> <?php echo strtoupper($row['middlename'])?> <?php echo strtoupper($row['suffix'])?></td>
                                                        ...
                                                        <td><?php echo $row['birthday']?></td>                                <td><?php echo $rowregion['regDesc']?></td>                                <td><?php echo $rowregion2['provDesc']?></td>            <td><?php echo $rowregion3['citymunDesc']?></td>                               <td><?php echo $rowregion4['brgyDesc']?></td>                            <td><?php echo $row['address']?></td>                                                                          <td><?php echo $rowregion4['brgyDesc']?> <?php echo $rowregion3['citymunDesc']?>, <?php echo $rowregion2['provDesc']?> </td>                    
                                                           <td><?php echo $row['latitude']?></td>  
                                                           
                                                              <td><?php echo $row['longitude']?></td>                                                                                     <td>
                                   ...
                                   ?>                                                                 
                                                                                            ...
                                                                                            <td><?php echo $row['approve_agent']?></td>                                                                     <td><?php echo $row['approve_admin']?></td>                                                                     
                                                                                                                            	   <td>
                                                                                                                            	       ...
                                                                                                                            	       <a href="edit_salesc.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Application</font></a></td>
