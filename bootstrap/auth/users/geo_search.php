...
?>           
                  <form method="POST"  action="geotagging.php" enctype='multipart/form-data'>  
                       ...
                       <div class="col-12 col-md-4 col-lg-4"> 
                        ...
                        <select name="region"  class="form-control" required="">
                           ...
                           <option>All</option>
                            ...
                            $query=mysqli_query($con,"SELECT * FROM refregion order by id asc")or die(mysqli_error($con));
	while($row=mysqli_fetch_array($query)){
                    ...
                    <div class="card-footer text-right">
                      <button name="" class="btn btn-primary">Filter</button>
                    </div>
                  </form>
                </div>
