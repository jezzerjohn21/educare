...
$sid=$_GET['id'];
$query=mysqli_query($con,"SELECT * FROM rebates WHERE id='$sid' ")or die(mysqli_error($con));
...
$exp=$_POST['exp'];
	mysqli_query($con,"update rebates set expiration='$exp',name='$prod_code',type='$type',percentage='$percentage'  where id='$id'")or die(mysqli_error());
...
?>           
                  <form method="POST"  enctype='multipart/form-data'>  
                    <div class="card-header">
                      ...
                      <h4>Update Rebates Information</h4>
                    </div>
                    <div class="card-body">
