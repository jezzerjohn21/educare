...
$('#text').html(enteredtext);
                ...
                <div id="text22" class="card">
                      ...
                      <center>
                          <br>
                    <h4>Loyaleadsta CRM Sales Reports</h4>
                    <br>
...
$total=0;
$query=mysqli_query($con,"select * from  temp_prod where  date(date_added)>='$invoice' and date(date_added)<='$invoice2' and status!='Pending' order by id asc")or die(mysqli_error());
