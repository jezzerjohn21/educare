...
$query=mysqli_query($con,"select * from  user where type='4'  order by lastname asc")or die(mysqli_error());
                                   ...
                                   ?>                                                                 
                                                                                                                          ...
                                                                                                                          <td><?php echo $row['date_added']?></td>
                                                                                                                            	   ...
                                                                                                                            	   <td>
                                                                                                                            	       ...
                                                                                                                            	       <a href="edit_marketing.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Edit</font></a></td>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Marketing User Registration</h5>
...
if($row21a1a<=0){
		  ...
		  mysqli_query($con,"INSERT INTO user(gender,id_number,firstname,middlename,lastname,suffix,status,email,contact,date_added,password,birthday,region,province,city,barangay,address,sponsor_id,type) VALUES('Male','$id_number','$firstname','$middlename','$lastname','$suffix','$status','$email','$contact','$date','$password','$bday','$region','$province','$city','$barangay','$address','$sponsor_id','4')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='marketing_user.php';
    }, 1000);
</script>
