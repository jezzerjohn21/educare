...
if($rowuser['type']==0){
$query=mysqli_query($con,"select * from  returns where status!='Pendings' order by id desc")or die(mysqli_error());
}else{
    
   $query=mysqli_query($con,"select * from  returns where status!='Pendings' and sales_agent='$com' order by id desc")or die(mysqli_error()); 
					...
					<td><?php echo $row['date_added']?></td>
                  		<td><?php echo $rowcateg2a['firstname']?> <?php echo $rowcateg2a['lastname']?></td>
							...
							<td class="text-center"><span class="active"><?php echo $row['status']?></span></td> <!--Status-->
								   ...
								   <td><a href="edit_returns.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Update</font></a></td>
						</tr>
					...
					<td><b><?php echo $row['date_added']?></b> </td>
                  		<td><b><?php echo $rowcateg2a['firstname']?> <?php echo $rowcateg2a['lastname']?></b> </td>
							...
							<td class="text-center"><span class="active"><b><?php echo $row['status']?></b> </span></td> <!--Status-->
								   ...
								   <td><a href="edit_returns.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Update2</font></a></td>
						</tr>
