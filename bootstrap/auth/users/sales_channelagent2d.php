...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Pending' and account_type='Dealer' and region='$region' order by lastname asc")or die(mysqli_error());
