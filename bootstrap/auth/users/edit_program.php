...
$sid=$_GET['id'];
$query=mysqli_query($con,"SELECT * FROM program WHERE id='$sid' ")or die(mysqli_error($con));
...
$exp=$_POST['exp'];
	mysqli_query($con,"update program set expiration='$exp',name='$prod_code',type='$type',percentage='$percentage'  where id='$id'")or die(mysqli_error());
