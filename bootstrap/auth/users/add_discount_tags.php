...
<td><a href="delete_discount_tags.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="white">Delete</font></a></td>                                        	   
...
$query2=mysqli_query($con,"select * from  discount_tag  where dis_id='$prod_code' and categ_id='$prod_image'")or die(mysqli_error());
$row2=mysqli_num_rows($query2);


if($row2<=0){
		  mysqli_query($con,"INSERT INTO discount_tag(categ_id,dis_id) VALUES('$prod_image','$prod_code')")or die(mysqli_error($con));
		  
}	  
		  

		 
	echo "<script>window.location='add_discount_tags.php?id=$prod_code'</script>";   
