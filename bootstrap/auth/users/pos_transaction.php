              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Point of Sales Transactions</h4>
...
$query=mysqli_query($con,"select * from  sales  order by id asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="receipt_view.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['cust_id'];?>&invoice=<?php echo $row['invoice'];?>"   class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
							</td>
																		  <td><?php 
		...
		?>	</td>  
				...
				<td>₱  <?php echo number_format($row['balance'],2)?></td> <!--Price-->
					 ...
					 <td><?php echo $row['payment_option']?></td>
							     ...
							     <td><?php echo $rowcateg2['business_name']?></td>   
