...
$sid=$_GET['id'];
$query=mysqli_query($con,"SELECT * FROM discounts WHERE id='$sid' ")or die(mysqli_error($con));
...
$exp=$_POST['exp'];
	mysqli_query($con,"update discounts set type2='$type2',expiration='$exp',name='$prod_code',type='$type',percentage='$percentage'  where id='$id'")or die(mysqli_error());
...
?>           
                  <form method="POST"  enctype='multipart/form-data'>  
                    <div class="card-header">
                      ...
                      <h4>Update Discount Information</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        ...
                        <select name="type2" type="text" class="form-control" required="">
                            <option ><?php echo $row['type2'];?></option>
                            <option>Percentage</option>
                              <option>Fixed</option>
                            </select>
                      </div>    
