              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Dealer Account (Rejected Application)</h4>
                    <div class="b">
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Reject' and sponsor_id='$id_n' and account_type='Dealer' and region='$region'  order by lastname asc")or die(mysqli_error());
