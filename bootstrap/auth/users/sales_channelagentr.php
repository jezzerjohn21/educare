              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Dealer/Distributor Account (Agent Rejected)</h4>
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Rejected' order by lastname asc")or die(mysqli_error());
