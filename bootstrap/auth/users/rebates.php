            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  data-feather="plus"></i>Add Rebates</font></button>
...
$query=mysqli_query($con,"select * from  rebates  order by name asc")or die(mysqli_error());
 ...
 <td><?php echo $row['name']?></td>
  <td><?php echo $row['percentage']?></td>
                                      <td><?php echo $row['type']?></td>                               <td><?php echo $row['expiration']?></td>                                                       	   <td>
                                       	       <a href="edit_rebates.php?id=<?php echo $row['id'];?>" class="btn btn-success"><font color="white">Edit</font></a></td>
                                                                                                                          	   <td>
                                       	       <a href="delete_rebates.php?id=<?php echo $row['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="white">Delete</font></a></td>                                        	                                          	   
