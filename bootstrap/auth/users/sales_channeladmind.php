              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Dealer Account (Admin Approval)</h4>
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_admin='Pending' and approve_agent='Approved' and account_type='Dealer' order by lastname asc")or die(mysqli_error());
