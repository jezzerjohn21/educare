              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Dealer/Distributor Account (Approved)</h4>
...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Approved' and sponsor_id='$id_n' order by lastname asc")or die(mysqli_error());
