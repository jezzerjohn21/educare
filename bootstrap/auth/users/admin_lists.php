...
$query=mysqli_query($con,"select * from  user where type='0'  order by lastname asc")or die(mysqli_error());
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Administrator Registration</h5>
...
if($row21a1a<=0){
		  ...
		  mysqli_query($con,"INSERT INTO user(gender,id_number,firstname,middlename,lastname,suffix,status,email,contact,date_added,password,birthday,region,province,city,barangay,address,sponsor_id,type) VALUES('Male','$id_number','$firstname','$middlename','$lastname','$suffix','$status','$email','$contact','$date','$password','$bday','$region','$province','$city','$barangay','$address','$sponsor_id','0')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='admin_lists.php';
    }, 1000);
</script>
