...
$query=mysqli_query($con,"select * from  user where type='2' and approve_agent='Approved' and approve_admin='Approved' and account_type='Distributor' order by lastname asc")or die(mysqli_error());
                            ...
                            <td><?php echo $count?></td>
                                ...
                                <td><?php echo $row['account_type']?></td>
                                      ...
                                      <td><?php echo strtoupper($row['lastname'])?>, <?php echo strtoupper($row['firstname'])?> <?php echo strtoupper($row['middlename'])?> <?php echo strtoupper($row['suffix'])?></td>
                                                        ...
                                                        <td><?php echo $row['birthday']?></td>                                <td><?php echo $rowregion['regDesc']?></td>                                <td><?php echo $rowregion2['provDesc']?></td>            <td><?php echo $rowregion3['citymunDesc']?> </td>                                                     <td><?php echo $row['address']?></td>       
                                                        <td><?php echo $row['address']?></td>                                  <td><?php echo $rowregion4['brgyDesc']?> <?php echo $rowregion3['citymunDesc']?>, <?php echo $rowregion2['provDesc']?> </td>                    
