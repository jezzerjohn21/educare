...
$added_on=date("Y-m-d H:i");
		  ...
		  mysqli_query($con,"INSERT INTO ticket(title,message,date_added,user_id,ticket_no,status) VALUES('$prod_image','$message','$added_on','$com','$ticket_no','Pending')")or die(mysqli_error($con));
