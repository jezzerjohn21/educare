...
<html>
  ...
  font-family: "Inter-Regular";
						...
						<li> 
							...
							<ul class="submenu">
								<a href="delivery.php?login=<?php echo $_GET['login'];?>"><li> Delivery</li></a>
								<a href="return.php?login=<?php echo $_GET['login'];?>"><li class="pb-0"> Return</li></a>
							</ul>
						</li>
						<li> 
...
?>
								...
								<button onclick="window.location.href='choose_client.php?login=<?php echo $_GET['login'];?>'" class="users-button"><i class="fa fa-users"></i></button>
								</div>
						...
						<div class="search-container">
							...
							<input type="text" id="search" name="search" class="search-product" placeholder="Search Product">
						</div>

						<div class="product-container">
							<!-- id="spc_{}" -->
							<!-- change the {} with the product id -->
...
$prod=$row['id'];
$query2=mysqli_query($con,"select * from  cart where added_by='$com' and prod_id='$prod' and status=''")or die(mysqli_error());
$row2=mysqli_fetch_array($query2);

$cc=$row['prod_categ'];


$query2c=mysqli_query($con,"select * from  category where id='$cc' ")or die(mysqli_error());
$rowc=mysqli_fetch_array($query2c);

    ?>
			
							
							
							<div class="single-product-container" id="spc_<?php echo $row['id'];?>">
								...
								<div class="row">
									...
									<div class="col-2 col-sm-2">
										<img id="product-image" src="../auth/users/products/<?php echo $row['prod_image'];?>" alt="NoPath_-_Copy_7" >
									</div>
								    ...
								    <?php
								       	    ...
								       	    ?>
								    			...
								    			<div class="col-2 col-sm-2">
										<img  id="product-image" src="icon_new.fw.png" alt="" >
									</div>    
								      			    <?php  
								    }
								    ?>
									...
									<div class="col-7 col-sm-8 p-0 mb-1">
										<div id="product-name">
											<span><?php echo $row['prod_name'];?> (<?php echo $rowc['name'];?>)</span>
										</div>
										<div id="price-and-type">
											<span><?php echo $row['prod_price'];?>/<?php echo $row['prod_unit'];?></span>
										</div>
									</div>
									...
									<div class="col-2 p-0 pl-0">
										<div class="remain-stock-container">
											<!-- class="prod_quan_id_{}" -->
											<!-- change the {} with the id of the product -->
											<!-- onclick openModal value is id, product name and priceandtype -->
											<button id="prod_quan<?php echo $row['id'];?>" class="prod_quan_id_<?php echo $row['id'];?>" onclick="openModal(<?php echo $row['id'];?>, '<?php echo $row['prod_price'];?>', '<?php echo $row['prod_price'];?>')">
												<span><? echo number_format($row2['qty'],0);?></span>
											</button>
										</div>
									</div>
...
return false;
					...
					<div class="product-billed-container f-13 big-screen-view">
...
$queryqq=mysqli_query($con,"select * from  cart  where added_by='$com' and status='' ")or die(mysqli_error());
    ...
    ?>
					...
					<div class="discount-container">
						...
						<div class="row h-100">
							...
							<?php
							$di=$_GET['login'];
							$querydiscount=mysqli_query($con,"select * from  cart_dis  where added_by='$di' and status=''")or die(mysqli_error());
$count=mysqli_num_rows($querydiscount);
							...
							<div class="col-sm-1 col-1 text-center pr-0 with-selected-discount">
								<div class="wrapper">
									<a href="discount.php?login=<?php echo $_SESSION['id'];?>&cus=<?php echo $_GET['cus'];?>" class="w-100 select_color"><i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
							...
							<div class="col-sm-5 col-5 text-right no-selected-discount">
								<div class="wrapper">
									<a href="discount.php?login=<?php echo $_SESSION['id'];?>&cus=<?php echo $_GET['cus'];?>" class="w-100 select_color"><font size="2px">Select Discount</font> <i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
					...
					<div class="rebate-container">
						...
						<div class="row h-100">
							...
							<div class="col-sm-5 col-5 text-right no-selected-rebate">
								<div class="wrapper">
									<a href="rebate.php?login=<?php echo $_SESSION['id'];?>&cus=<?php echo $_GET['cus'];?>" class="w-100 select_color"><font size="2px">Select Rebate</font> <i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
					...
					<div class="reward-container">
						...
						<div class="row h-100">
							...
							<div class="col-sm-5 col-5 text-right no-selected-reward">
								<div class="wrapper">
									<a href="reward.php?login=<?php echo $_SESSION['id'];?>&cus=<?php echo $_GET['cus'];?>" class="w-100 select_color"><font size="2px">Select Reward</font> <i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
...
<script type="text/javascript">
					...
					<div   onkeyup=""  class="total-amount-container">
						...
						<div class="row mt-1">
							...
							<div class="col-sm-6 col-6 text-right">
								<span id="dis" class="discount-amount"></span>
							</div>
...
while($row2ata=mysqli_fetch_array($query2ata)){  
						...
						<div class="row mt-1">
							...
							<div class="col-sm-6 col-6 text-right">
								...
								<span id="display_info2" class="subtotal-amount"> 	</span>
							</div>
...
?>
						<div class="row m-0">
							<button onclick="window.location.href='checkout.php?login=<?php echo $_GET['login'];?>&cus=<?php echo $_GET['cus'];?>'" class="proceed-to-checkout-btn">Proceed to Checkout</button>
						</div>
<?php
}else{
?>
	<div class="row m-0">
							<button  class="proceed-to-checkout-btn">Please select customer</button>
						</div>
