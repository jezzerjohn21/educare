...
?>
	...
	<span class="filter_by">Filter By:</span>
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected">Invoice Number (asc)</option>
				<option value="0_desc">Invoice Number # (desc)</option>

				<option value="1_asc">Customer Name (asc)</option>
				<option value="1_desc">Customer Name (desc)</option>
...
$query=mysqli_query($con,"select * from  sales_crm where store='$com' order by id asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="crm_view.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['user_id'];?>&invoice=<?php echo $row['invoice'];?>"   class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
							</td>
											  <td><?php 
		...
		?>	</td>  
				  ...
				  <td><?php echo $rowcateg2a2['firstname']?> <?php echo $rowcateg2a2['lastname']?></td>  
							...
							<td class="text-center"><span class="active"><?php 	if($row['status']=="Paid"){
										...
										}else if($row['status']=="On-processing"){
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
									<a href="crm_view.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['cust_id'];?>&invoice=<?php echo $row['invoice'];?>"  class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
									</div>
									<div class="col-4">
								...
								<div class="row mt-1">
									...
									<div class="row mt-1">
									<div class="col-6">
												<span class=""><?php echo $rowcateg2a2['firstname']?> <?php echo $rowcateg2a2['lastname']?></span>
									</div>
										<div class="col-6">
												<span class="">								<?php 
