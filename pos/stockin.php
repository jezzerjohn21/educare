...
?>
        ...
        <a  style="padding:10px" href="add_stock.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i>Stocks</center></a>
...
<td><?php echo $row['prod_name']?></td>
 <td><?php echo $row['prod_code']?></td>
					...
					?>
					<td bgcolor="red"><font color="white"><?php echo number_format($row['prod_qty'],0)?></font></td> <!--Quantity-->
