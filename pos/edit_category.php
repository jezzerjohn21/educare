...
$upon=date("Y-m-d H:i");
$up=$_SESSION['id'];
	mysqli_query($con,"update category set name='$prod_image' where id='$id'")or die(mysqli_error());
...
$number = sprintf('%06d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Category Information</span>
					</div>
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
							...
							<div class="mt-p5">
								<input type="text" id="name" value="<?php echo $row['name'];?>" name="name" placeholder="Name" required>
							</div>
