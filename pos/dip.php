...
?>
        ...
        <a  style="padding:10px" href="add_dip.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i>Add</center></a>
			...
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected">Code (asc)</option>
				<option value="0_desc">Code # (desc)</option>

				<option value="1_asc">Product (asc)</option>
				<option value="1_desc">Product (desc)</option>
...
$query222=mysqli_query($con,"select DISTINCT code from  dip where user_id='$com' order by id asc")or die(mysqli_error());
while($row222=mysqli_fetch_array($query222)){  

$comd=$row222['code'];
$query=mysqli_query($con,"select * from  dip where code='$comd' order by id asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="dip2.php?login=<?php echo $_GET['login'];?>&code=<?php echo $row['code'];?>"  class="order_id"><?php echo $row['code']?></a> <!--Order ID-->
							</td>
...
$query=mysqli_query($con,"select * from  dip where user_id='$com' order by id asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								...
								<div class="row mt-1">
									<div class="col-6">
										<span class="name-inv"><?php echo $row['packaging']?></span>
									</div>
									<div class="col-6">
										<span class="category-inv"><?php echo $row['target']?></span>
									</div>
								</div>
								<div class="row mt-p5">
									<div class="col-12">
										<span class="quantity-inv"><?php echo $row['budget']?></span>
									</div>
									<div class="col-12">
										<span class="threshold-inv"><?php echo $row['incentive']?></span>
									</div>
										<div class="col-12">
