...
?>
        ...
        <a  style="padding:10px" href="add_discount.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
...
$query=mysqli_query($con,"select * from  discounts where company='$com' order by name asc")or die(mysqli_error());
...
<td><?php echo $count?></td>
 <td><?php echo $row['name']?></td>
  <td><?php echo $row['percentage']?></td>
                                      <td><?php echo $row['type']?></td>                               <td><?php echo $row['expiration']?></td>                                       <td><?php echo $row['type2']?></td> 
...
$rowcateg=mysqli_fetch_array($querycate);  
                                      	   ...
                                      	   <td>
                                       	       <a href="add_discount_tags.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>" class="btn btn-success"><font color="green">Add Tags</font></a></td>
                                      
                           
                                                                                                                          	   <td>
                                       	       <a href="delete_discount.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['login'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></td>                                        	                                          	   
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-4">
										<span class="active"><?php echo $row['percentage']?></span>
									</div>
								</div>
								<div class="row mt-1">
									<div class="col-12">
										<span class="d-block border-bottom"><?php echo $row['type2']?></span>
									</div>
								</div>
								<div class="row mt-1">
									<div class="col-6">
										<span class="name-inv"><?php echo $row['type']?></span>
									</div>
									<div class="col-6">
										<span class="category-inv"><?php echo $row['expiration']?></span>
									</div>
								</div>
				
								<div class="row mt-p5">
									<div class="col-6">
										<span class="price-kilo-inv"><a href="delete_discount.php?id=<?php echo $row['id'];?>&id2=<?php echo $_GET['login'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></span>
									</div>
									<div class="col-6">
										<span class="points-inv"> <a href="add_discount_tags.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>" class="btn btn-success"><font color="green">Add Tags</font></a></span>
									</div>
								</div>
							</td>
