...
<html>
	...
	<body>
						...
						<div class="menu-container">
							<div class="user-info-container">
								<div class="row">
									...
									<div class="col-9">
										<p class="sidebar-username d-block">Nikki</p>
										<p class="sidebar-my-account d-block">My Account</p>
									</div>
								</div>
							</div>

							<a href="#"><li> <i class="fa fa-tachometer-alt"></i> &ensp; Dashboard</li></a>
							...
							<li> 
								...
								<ul class="submenu">
									<a href="#"><li> POS Transactions</li></a>
									<a href="#"><li class="pb-0"> CRM Transactions</li></a>
								</ul>
							</li>
							<li> 
								...
								<ul class="submenu">
									...
									<a href="#"><li> Adjustments</li></a>
									<a href="#"><li> Transfers</li></a>
									<a href="#"><li class="pb-0"> Returns</li></a>
								</ul>
							</li>
							<a href="#"><li> <i class="fa fa-tag"></i> &ensp; Discounts</li></a>
							<a href="#"><li> <i class="fa fa-money-bill"></i> &nbsp; Payments</li></a>
							<a href="#"><li> <i class="fa fa-clipboard-list"></i> &ensp; Quotations</li></a>
							<li> 
								<label for="bookings"> <i class="fa fa-truck"></i> &ensp; Bookings </label><input type="checkbox" id="bookings">
								<ul class="submenu">
									<a href="#"><li> Delivery</li></a>
									<a href="#"><li class="pb-0"> Return</li></a>
								</ul>
							</li>
							<li> 
								...
								<ul class="submenu">
									...
									<a href="#"><li> Rebates</li></a>
									<a href="#"><li class="pb-0"> Referrals</li></a>
								</ul>
							</li>

							<div class="next-list"></div>
							
							<a href="#"><li> <i class="fa fa-history"></i> &ensp; Logs</li></a>
							<a href="#"><li> <i class="fa fa-cog"></i> &ensp; Support</li></a>
						</div>
					</ul>
        ...
        <a  style="padding:10px" href="add_product.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
			...
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected">Order ID (asc)</option>
				<option value="0_desc">Order ID # (desc)</option>

				<option value="1_asc">Name (asc)</option>
				<option value="1_desc">Name (desc)</option>

				<option value="2_asc">SKU (asc)</option>
				<option value="2_desc">SKU (desc)</option>

				<option value="3_asc">Category (asc)</option>
				<option value="3_desc">Category (desc)</option>

				<option value="4_asc">Unit (asc)</option>
				<option value="4_desc">Unit (desc)</option>

				<option value="5_asc">Price (asc)</option>
				<option value="5_desc">Price (desc)</option>

				<option value="6_asc">Quantity (asc)</option>
				<option value="6_desc">Quantity (desc)</option>

				<option value="7_asc">Threshold (asc)</option>
				<option value="7_desc">Threshold (desc)</option>

				<option value="8_asc">Points (asc)</option>
				<option value="8_desc">Points (desc)</option>

				<option value="9_asc">Added on (asc)</option>
				<option value="9_desc">Added on (desc)</option>

				<option value="10_asc">Added by (asc)</option>
				<option value="10_desc">Added by (desc)</option>

				<option value="11_desc">Updated on (asc)</option>
				<option value="11_asc">Updated on (desc)</option>

				<option value="12_asc">Updated by (asc)</option>
				<option value="12_desc">Updated by (desc)</option>

				<option value="13_asc">Status (asc)</option>
				<option value="13_desc">Status (desc)</option>
			</select>
...
$query=mysqli_query($con,"select * from  products where company='$com' order by prod_name asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="edit_prod.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $row['prod_no']?></a> <!--Order ID-->
							</td>
...
<td><?php echo $row['prod_name']?></td>
 <td><?php echo $row['prod_code']?></td>
					...
					<td><?php echo $row['prod_unit']?></td>
							<td>₱  <?php echo number_format($row['prod_price'],2)?></td> <!--Price-->
							<td><?php echo number_format($row['prod_qty'],0)?></td> <!--Quantity-->
...
<td><?php echo $row['points']?></td>
                     ...
                     <td><?php echo $row['update_on']?></td>  
							...
							<td class="text-center"><span class="active"><?php echo $row['prod_status']?></span></td> <!--Status-->
						</tr>
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
										<a href="edit_prod.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $row['prod_no']?></a>
									</div>
									<div class="col-4">
										<span class="active"><?php echo $row['prod_status']?></span>
									</div>
								</div>
								<div class="row mt-1">
									<div class="col-12">
								...
								<div class="row mt-1">
									<div class="col-6">
										<span class="name-inv"><?php echo $row['prod_name']?></span>
									</div>
									<div class="col-6">
										<span class="category-inv"><?php echo $rowcateg['name']?></span>
									</div>
								</div>
								<div class="row mt-p5">
									<div class="col-6">
										<span class="quantity-inv"><?php echo $row['prod_qty']?> left</span>
									</div>
									<div class="col-6">
										<span class="threshold-inv">TH: <?php echo $row['threshold']?></span>
									</div>
								</div>
								<div class="row mt-p5">
									<div class="col-6">
										<span class="price-kilo-inv">₱ <?php echo number_format($row['prod_price'],2)?> / <?php echo number_format($row['prod_unit'],2)?></span>
									</div>
									<div class="col-6">
										<span class="points-inv"><?php echo number_format($row['points'],2)?> points</span>
									</div>
								</div>
							</td>
