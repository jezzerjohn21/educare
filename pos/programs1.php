...
?>
        ...
        <a  style="padding:10px" href="add_program.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
...
$query=mysqli_query($con,"select * from  program where company='$com' order by name asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="edit_category.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $count?></a> <!--Order ID-->
							</td>
...
$query=mysqli_query($con,"select * from  category where company='$com' order by name asc")or die(mysqli_error());
while($row=mysqli_fetch_array($query)){  
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
										<a href="edit_category.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $count?></a>
									</div>
									<div class="col-4">
										<span class="active"><a href="edit_category.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $row['name']?></a></span>
									</div>
