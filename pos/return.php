...
?>
        ...
        <a  style="padding:10px" href="add_return.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i>Add</center></a>
...
$query=mysqli_query($con,"select * from  returns where store_id='$com' order by id asc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
										<a href=""  class="order_id"><?php echo $row['code']?></a>
									</div>
									<div class="col-4">
										<span class="active"><?php echo $rowcateg['prod_name']?></span>
									</div>
								</div>
								<div class="row mt-1">
									<div class="col-12">
								...
								<div class="row mt-1">
									...
									<div class="col-12">
										<span class="category-inv"><?php echo $row['qty']?></span>
									</div>
								</div>
								<div class="row mt-p5">
									<div class="col-12">
										<span class="quantity-inv"><?php echo $row['reason']?></span>
									</div>
									<div class="col-12">
										<span class="threshold-inv"><?php echo $row['remarks']?></span>
									</div>
										<div class="col-12">
										<span class="threshold-inv"><?php echo $row['remarks_sa']?></span>
									</div>
								</div>
								<div class="row mt-p5">
									<div class="col-6">
										<span class="price-kilo-inv"><?php echo $row['date_added']?></span>
									</div>
											<div class="col-6">
										<span class="price-kilo-inv"><?php echo $rowcateg2a['firstname']?> <?php echo $rowcateg2a['lastname']?></span>
									</div>
									<div class="col-6">
