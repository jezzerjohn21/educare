...
<html>
	...
	<body>
		...
		<button id="Group_2141">
			<a  href="pos_view.php?login=<?php echo $_GET['login'];?>&invoice=<?php echo $_GET['invoice'];?>" id="Group_2090">
...
<?php
$code=$_GET['invoice'];
$query2=mysqli_query($con,"select * from  cart_dis  where  invoice_no='$code'")or die(mysqli_error());
...
?>
				<div class="col-sm-6 col-12 " style="padding: 0;">
					...
					<div class="select-discounts-container">
