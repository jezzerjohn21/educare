...
$querycate2a2=mysqli_query($con,"select * from  user  where id='$com' ")or die(mysqli_error());
...
$querycate2a=mysqli_query($con,"select * from  user  where id_number2='$cat2a' ")or die(mysqli_error());
