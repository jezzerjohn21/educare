...
$querycate2a2=mysqli_query($con,"select * from  user  where id='$cat2a2' ")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="payment_enter.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['cust_id'];?>&invoice=<?php echo $row['invoice'];?>"   class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
							</td>
...
if($row['balance']<=0){
	...
	mysqli_query($con,"update sales set status='Paid' where id='$iii'")or die(mysqli_error());
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-4">
										<span class="active"><?php echo $rowcateg2a2['firstname']?> <?php echo $rowcateg2a2['lastname']?></span>
									</div>
								</div>
								<div class="row mt-1">
									<div class="col-12">
