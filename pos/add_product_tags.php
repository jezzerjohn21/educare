...
?>
        ...
        <a  style="padding:10px" href="add_product2.php?login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
...
<td><a href="delete_product_tags.php?id2=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></td>                                        	   
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-6">
										<span class="active"><a href="delete_product_tags.php?id2=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></span>
									</div>
								</div>
