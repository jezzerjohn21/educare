...
$total=0;
$vat=0;
$query=mysqli_query($con,"select * from  adjustment where store_id='$com' and date(date_added)>='$date1' and date(date_added)<='$date2' and type='Increase (+)' and status='APPROVED' order by id asc")or die(mysqli_error());
...
$total2=$rowcateg['prod_price']*$row['qty']*$cat2;
$totals=$totals+$total2;
$vat2=$rowcateg['prod_price']*$row['qty']*0.12;
$vats=$vats+$vat2;
}$y = date('Y',strtotime($date1));
				  ?>  
					    
        <a  style="padding:10px" href="summary_request.php?login=<?php echo $_GET['login'];?>&total=<?php echo $totals;?>&year=<?php echo $y;?>&vat=<?php echo $vats;?>&date1=<?php echo $date1;?>&date2=<?php echo $date2;?>" class="add-btn"><center>Request</center></a>
			...
			<select name="sortBy" id="sortBy">
				...
				<option value="1_asc">Product Name (asc)</option>
				<option value="1_desc">Product Name (desc)</option>
...
$total=$rowcateg['prod_price']*$row['qty']*$cat2;
...
<td><?php echo $rowcateg['prod_name']?></td>
					...
					<td><?php echo $row['qty']?></td>
						<td><?php echo $rowcateg['prod_price']?></td>
							<td><?php echo number_format($row['qty']*$rowcateg['prod_price'],2)?></td>
							<td><?php echo $cat2?></td>
											<td><?php echo number_format($rowcateg['prod_price']*$row['qty']*0.12,2);?></td>	
         				<td><?php echo number_format($rowcateg['prod_price']*$row['qty']*$cat2,2);?></td>
							...
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-12 mt-5">
										<span class=""><?php echo $rowcateg['prod_name']?></span>
									</div>
									<div class="col-12 mt-5">
										<span class="">QTY: <?php echo $row['qty']?></span>
									</div>
											<div class="col-12 mt-5">
										<span class="">PRICE: <?php echo $rowcateg['prod_price']?></span>
									</div>
											<div class="col-12 mt-5">
										<span class="">TOTAL
										: <?php echo number_format($row['qty']*$rowcateg['prod_price'],2)?></span>
									</div>
							
									<div class="col-12 mt-5">
										<span class="">%: <?php echo $cat2?></span>
									</div>
										<div class="col-12 mt-5">
										<span class="">VAT: <?php echo number_format($rowcateg['prod_price']*$row['qty']*0.12,2);?></span>
									</div>
						<div class="col-12 mt-5">
										<span class="">% Rebates: <?php echo number_format($rowcateg['prod_price']*$row['qty']*$cat2,2);?></span>
									</div>
								</div>
								</div>
							</td>
