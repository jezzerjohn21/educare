 ...
 <td><?php echo $row['prod_code']?></td>
					...
					<td><?php echo $row['prod_unit']?></td>
							<td>₱  <?php echo number_format($row['prod_price'],2)?></td> <!--Price-->
										<td>₱  <?php echo number_format($row['crm_price'],2)?></td> <!--Price-->
						<?php
					
					if($row['threshold']<$row['prod_qty']){
					?>
					...
					?>
					<td ><font color="#DF0101"><?php echo number_format($row['prod_qty'],0)?></font></td> <!--Quantity-->
...
$rowcateg=mysqli_fetch_array($querycate);  
                                      	   ...
                                      	   <td>
                                       	       <a href="add_product_tags.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>" class="btn btn-success"><font color="green">Add Tags</font></a></td>
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								...
								<div class="row mt-p5">
									<div class="col-4">
										<span class="price-kilo-inv">POS: ₱ <?php echo number_format($row['prod_price'],2)?> / <?php echo $row['prod_unit']?></span>
									</div>
											<div class="col-4">
										<span class="price-kilo-inv">CRM: ₱ <?php echo number_format($row['crm_price'],2)?> / <?php echo $row['prod_unit']?></span>
									</div>
									<div class="col-4">
