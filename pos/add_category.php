...
<html>
	...
	<body>
		...
		<a href="category.php?login=<?php echo $_GET['login'];?>"> 	<svg class="Rectangle_1637_">
...
{
    $com=$_GET['login'];
$prod_image=$_POST['prod_name'];

	$query21a1=mysqli_query($con,"select * from  category where name='$prod_image' and company='$com' ")or die(mysqli_error());
...
$added_on=date("Y-m-d H:i");
		  ...
		  mysqli_query($con,"INSERT INTO category(name,company) VALUES('$prod_image','$com')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='category.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
<?php
    ...
    <script type="text/javascript">
    window.setTimeout(function() {
       window.location.href='add_category.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
swal("Ops!", "Category Already Used!", "warning");
...
$number = sprintf('%06d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Enter Category Information</span>
					</div>
						...
						<!-- <form action=""> -->
							...
							<div class="row reverse-order">
								...
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Add Category</button>
								</div>
							</div>
						</form>
