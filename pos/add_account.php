...
<html>
	...
	<body>
		...
		<a href="myaccount.php?login=<?php echo $_GET['login'];?>"> 	<svg class="Rectangle_1637_">
...
{
    $com=$_GET['login'];
$prod_image=$_POST['code'];



	$query21a1d=mysqli_query($con,"select * from  user where id_number='$prod_image' and account_type='Distributor' ")or die(mysqli_error());
$row21a1ad=mysqli_num_rows($query21a1d);
$row21a1adf=mysqli_fetch_array($query21a1d);
if($row21a1ad>=1){
    
    $iii=$row21a1adf['id'];
    
	$query21a1=mysqli_query($con,"select * from  my_distri where distri='$iii' and user_id='$com' ")or die(mysqli_error());
...
$added_on=date("Y-m-d H:i");
		  ...
		  mysqli_query($con,"INSERT INTO my_distri(distri,user_id) VALUES('$com','$iii')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='add_account.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
swal("Ops!", "Already Added!", "warning");
...
?>           
   ...
   <?php
	...
	$query21a1=mysqli_query($con,"select * from  category ")or die(mysqli_error());
$row21a1a=mysqli_num_rows($query21a1);
...
$number = sprintf('%06d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Enter Distributor Code Information</span>
					</div>
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
							...
							<div class="mt-p5">
								<input type="text" id="name" name="code" placeholder="Distributor Code" required>
							</div>
					
							<div class="row reverse-order">
							
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Add Distributor</button>
								</div>
							</div>
						</form>
