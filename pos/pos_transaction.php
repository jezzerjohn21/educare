				  ...
				  ?>  
						...
						<tr>
							<td class="text-center">
								<a href="pos_view.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['cust_id'];?>&invoice=<?php echo $row['invoice'];?>"   class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
							</td>
										  <td><?php 
							...
							<td class="per-inv-product-container">
								...
								<div class="row mt-1">
									<div class="col-12">
										...
										<div class="row mt-1">
								    	<div class="col-12">
										<span ><?php echo $rowcateg2a2['firstname']?> <?php echo $rowcateg2a2['lastname']?></span>
									</div>
									</div>
								...
								<div class="row mt-1">
									...
									<div class="col-6">
										<span class="category-inv">₱  <?php echo number_format($row['balance'],2)?></span>
									</div>
								</div>
