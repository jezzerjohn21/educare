...
<html>
	...
	<body>
		...
		<a href="discount1.php?login=<?php echo $_GET['login'];?>"> 	<svg class="Rectangle_1637_">
...
$type2=$_POST['type2'];
$exp=$_POST['exp'];
	$query21a1=mysqli_query($con,"select * from  discounts where name='$invoice' and company='$com'")or die(mysqli_error());
...
$ses=$_SESSION['id'];
		  ...
		  mysqli_query($con,"INSERT INTO discounts(type2,company,expiration,name,percentage,type) VALUES('$type2','$com','$exp','$invoice','$percentage','$type')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='discount1.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
?>           
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Enter Discount Information</span>
					</div>
					...
					<div class="col-12 mt-1">
                        ...
                        <input name="name" type="text" Placeholder="Discount Name"  required="">
                      </div>
                        ...
                        <input name="percentage" Placeholder="Amount/Percentage" type="text" required="">
                      </div>
                                    			<div class="mt-p5">
         
                        <input name="exp" type="text"  Placeholder="Expiration ex. 2021-11-06"  required="">
                      </div>
                        ...
                        <select name="type2" type="text"  required="">
							...
							<div class="row reverse-order">
								...
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Add Discount</button>
								</div>
							</div>
						</form>
