...
<html>
	...
	<body>
		<div id="T_15A_POS_Inventory">
			...
			<div id="Inventory">
				<span>Request for Special Terms</span>
			</div>
...
?>
        ...
        <a  style="padding:10px" href="add_request.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center>Request </center></a>
...
$query=mysqli_query($con,"select * from  rebates_request where user_id='$com' order by id asc")or die(mysqli_error());
							...
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-12 mt-5">
										<span class="active">Date: <?php echo $row['date_added']?></span>
									</div>
										<div class="col-12 mt-5">
										<span class="active">Amount: <?php echo $row['amount']?></span>
									</div>
										<div class="col-12 mt-5">
										<span class="active">Approver: <?php echo $row2['firstname']?> <?php echo $row2['lastname']?></span>
									</div>
										<div class="col-12 mt-5">
										<span class="active">Status: <?php echo $row['status']?></span>
									</div>
										<div class="col-12 mt-5">
										<span class="active">Remarks: <?php echo $row['remarks']?></span>
									</div>
								</div>
