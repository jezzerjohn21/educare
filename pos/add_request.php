...
<html>
	...
	<body>
		...
		<a href="rebates1.php?login=<?php echo $_GET['login'];?>"> 	<svg class="Rectangle_1637_">
...
$number = sprintf('%06d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Enter Date Range</span>
					</div>
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
				                  <form method="POST" action="yer.php?login=<?php echo $_GET['login'];?>" enctype='multipart/form-data'>  
				                  
				                 <input name="request_id" value="<?php echo $number;?>" type="hidden" class="form-control" required="">
							<div class="mt-p5">
								<input type="date" class="form-control" id="name" name="date1s" placeholder="Name" required>
							</div>
							<div class="mt-p5">
								<input type="date" class="form-control" id="name" name="date2s" placeholder="Name" required>
							</div>
							<div class="row reverse-order">
							
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Select</button>
								</div>
							</div>
						</form>
