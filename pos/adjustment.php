...
?>
        ...
        <a  style="padding:10px" href="add_adjustment.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i>Add</center></a>
...
$query=mysqli_query($con,"select * from  adjustment where store_id='$com' order by id asc")or die(mysqli_error());
