				...
				<div class="col-sm-7 col-12">
					...
					<div class="form-container">
						...
						<div class="search-container">
							...
							<input type="text" id="search" name="search" placeholder="Search Rebates">
						</div>
...
$query=mysqli_query($con,"select * from  discounts  order by name asc")or die(mysqli_error());
							...
							<div class="single-discount-container" id="sdc_1">
								...
								<div class="row">
									...
									<div class="col-2 col-sm-2">
										<img id="discount-image" src="peso_icon.png" alt="billing image">
									</div>
    ...
    ?>				
				...
				<div class="col-sm-5 col-12 bg-white sticky z-index-100" style="padding: 0;">
					...
					<div class="select-discounts-container big-screen-view">
						...
						<div class="row mt-2">
							<div class="col-12">
								<span class="selected-discounts">Selected Rebates</span>
					...
					<div class="apply-button-container">
						...
						<div class="row">
							<button class="apply-discount">Apply Rebates</button>
						</div>
