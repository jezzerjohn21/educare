...
?>
        ...
        <a  style="padding:10px" href="add_account.php?login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
			
				<span class="filter_by">Filter By:</span>
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected"> ID (asc)</option>
				<option value="0_desc"> ID # (desc)</option>
...
$query=mysqli_query($con,"select * from  my_distri  where distri='$id3'")or die(mysqli_error());
...
$querycate=mysqli_query($con,"select * from  user where id='$id'")or die(mysqli_error());
...
<td><?php echo $rowcateg['id_number']?></td>  

<td><?php echo $rowcateg['business_name']?></td>    
<td><?php echo $rowcateg['firstname']?> <?php echo $rowcateg['lastname']?></td>  
<td><?php echo $rowcateg['business_email']?></td>  
<td><?php echo $rowcateg['business_contact']?></td>  



<td><a href="delete_account.php?id2=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></td>                                        	   
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									...
									<div class="col-6">
								<?php echo $rowcateg['id_number']?>
									</div>
								</div>
					
							<div class="row">
									<div class="col-6">
									<?php echo $rowcateg['business_name']?>
									</div>
									<div class="col-6">
							<?php echo $rowcateg['firstname']?> <?php echo $rowcateg['lastname']?>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-6">
								<?php echo $rowcateg['business_email']?>
									</div>
									<div class="col-6">
						<?php echo $rowcateg['business_contact']?>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-6">
										<span class="active"><a href="delete_account.php?id2=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>" onClick="javascript:return confirm('are you sure you want to delete this?');" class="btn btn-danger"><font color="red">Delete</font></a></span>
									</div>
								</div>
