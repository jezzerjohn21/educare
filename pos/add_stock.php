...
<html>
	...
	<body>
		...
		<a href="stockin.php?login=<?php echo $_GET['login'];?>"> 	<svg class="Rectangle_1637_">
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='stockin.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
<?php
    ...
    <script type="text/javascript">
    window.setTimeout(function() {
        window.location.href='add_stock.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
$number = sprintf('%06d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Stockin Information</span>
					</div>
					...
					<div class="col-12 mt-1">
                        ...
                        <input name="invoice" Placeholder="Invoice Number" type="text" class="form-control" required="">
							...
							<div class="mt-1">
                                         ...
                                         <option value="">--Please Select Products--</option>
                           				<?php
$com=$_GET['login'];
$querycate=mysqli_query($con,"select * from  products  where company='$com' order by prod_code asc")or die(mysqli_error());
while($rowcateg=mysqli_fetch_array($querycate)){  

				  ?> 
                        <option value='<?php echo $rowcateg['id'];?>'><?php echo $rowcateg['prod_code'];?> ( <?php echo $rowcateg['prod_name'];?> ) <b><?php echo $rowcateg['prod_qty'];?></b></option>
                 <?php
}
                 ?>
							...
							<div class="mt-1">
							 <input name="qty" type="number" class="form-control" placeholder="Quantity" required="">
							</div>
							...
							<div class="mt-1">
							 <input name="date_purchase" type="text" class="form-control" placeholder="Date Purchased ex. MM/DD/YYYY" required="">
							</div>
									<div class="mt-1">
							 <input name="date_receive" type="text" class="form-control" placeholder="Date Received ex. MM/DD/YYYY" required="">
							</div>
							
							
									<div class="mt-1">
								<textarea id="description" name="remarks" rows="6" placeholder="Remarks" required></textarea>
							</div>
							...
							<div class="row reverse-order">
								...
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Stockin</button>
								</div>
							</div>
						</form>
