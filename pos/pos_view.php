...
$code=$_GET['invoice'];
$queryqq=mysqli_query($con,"select * from  cart  where invoice_no='$code'")or die(mysqli_error());
$rowqq=mysqli_fetch_array($queryqq);
    $dis=$rowqq['cust_id'];
    
    $query2p2=mysqli_query($con,"select * from  user  where id='$dis' ")or die(mysqli_error());
...
$count=mysqli_num_rows($querydiscount);
							...
							<div class="col-sm-5 col-5 text-right no-selected-discount">
								<div class="wrapper">
									<a href="discount_view.php?login=<?php echo $_SESSION['id'];?>&cus=<?php echo $_GET['cus'];?>&invoice=<?php echo $_GET['invoice'];?>" class="w-100 select_color"><font size="2px">Select Discount</font> <i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
...
$queryusersst=mysqli_query($con,"SELECT * FROM sales WHERE invoice='$code' ")or die(mysqli_error($con));
...
$queryuserss=mysqli_query($con,"SELECT sum(price) as total FROM cart WHERE invoice_no='$code' ")or die(mysqli_error($con));
...
$rowusersst=mysqli_fetch_array($queryusersst);		
						...
						<div class="row mt-1">
							...
							<div class="col-sm-6 col-6 text-right">
							    ...
							    <h3><?php echo number_format($rowusersst['grand_total'],2);?></h3>
