...
move_uploaded_file($_FILES["prod_image"]["tmp_name"], "../auth/users/products/" . $business_dti);
		  ...
		  mysqli_query($con,"INSERT INTO products(crm_price,prod_desc,added_by,added_on,points,threshold,prod_unit,prod_no,prod_image,prod_code,prod_name,prod_price,prod_categ,prod_status,company) VALUES('$crm_price','$prod_desc','$added_by','$added_on','$points','$threshold','$prod_unit','$prod_no','$business_dti','$prod_code','$prod_name','$prod_price','$prod_categ','$status','$com')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='product.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
<?php
    ...
    <script type="text/javascript">
    window.setTimeout(function() {
       window.location.href='add_product.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
?>           
   ...
   <?php
               $com=$_GET['login'];           
	$query21a1=mysqli_query($con,"select * from  products where company='$com'")or die(mysqli_error());
$row21a1a=mysqli_num_rows($query21a1);
				...
				<div class="row">
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
							...
							<div class="mt-p5">
								<input type="text" id="name" name="prod_name" placeholder="Name" required>
							</div>
							<div class="mt-1">
								<input type="text" id="sku" name="prod_code" placeholder="SKU" required>
							</div>
							<div class="mt-1">
							 ...
							 <option value="">--Category--</option>
                           				<?php
$com=$_GET['login'];
$querycate=mysqli_query($con,"select * from  category  where company='$com' order by name asc")or die(mysqli_error());
while($rowcateg=mysqli_fetch_array($querycate)){  
                 ...
                 ?>
							...
							<div class="mt-1">
								<textarea id="description" name="prod_desc" rows="6" placeholder="Description" required></textarea>
							</div>
							<div class="mt-1">
								<input type="text" id="unit" name="prod_unit" placeholder="Unit" required>
							</div>
							<div class="mt-1">
								<input type="text" id="price" name="prod_price" placeholder="POS Price" required>
							</div>
									<div class="mt-1">
								<input type="text" id="price" name="crm_price" placeholder="CRM Price" required>
							</div>
							<div class="mt-1">
								<input type="text" id="threshold" name="threshold" placeholder="Threshold" required>
							</div>
							<div class="mt-1">
