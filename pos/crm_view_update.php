...
<html>
	...
	<body>
		...
		<a href="crm_view.php?login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>&cus=<?php echo $_GET['cus'];?>&invoice=<?php echo $_GET['invoice'];?>"> 	<svg class="Rectangle_1637_">
...
$prod_image=$_POST['name'];


$upon=date("Y-m-d H:i");
$up=$_SESSION['id'];
	mysqli_query($con,"update sales_crm set status='$prod_image' where invoice='$id'")or die(mysqli_error());
    ...
    window.setTimeout(function() {
        window.location.href='crm_view.php?login=<?php echo $_GET['login'];?>&id=<?php echo $_GET['id'];?>&cus=<?php echo $_GET['cus'];?>&invoice=<?php echo $_GET['invoice'];?>;
    }, 1000);
</script>
...
$rowusersst=mysqli_fetch_array($queryusersst);		
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Transaction Information</span>
					</div>
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
							...
							<div class="mt-p5">
								<select type="text" id="name" value="<?php echo $row['name'];?>" name="name" placeholder="Name" required>
								        <option><?php echo $rowusersst['status'];?></option>
							...
							<div class="row reverse-order">
								...
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Updated</button>
								</div>
							</div>
						</form>
