...
?>
        ...
        <a  style="padding:10px" href="add_ticket.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>
...
$query=mysqli_query($con,"select * from  ticket where user_id='$com' and ticket_rep='' order by id desc")or die(mysqli_error());
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
										<a href="edit_support.php?id=<?php echo $row['ticket_no'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $row['ticket_no'];?></a>
									</div>
									<div class="col-4">
										<span class="active"><a href="edit_category.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>"  class="order_id"><?php echo $row['title']?></a></span>
									</div>
								</div>
