...
$cat=$_GET['login'];
$cat2=$_GET['id'];
$querycate2=mysqli_query($con,"select * from temp_prod where user_id='$cat' and store='$cat2' and status='Pending' ")or die(mysqli_error());
while($rowcateg2=mysqli_fetch_array($querycate2)){
    
    $qty=$qty+$rowcateg2['qty'];
    
    $tot=$rowcateg2['qty']*$rowcateg2['price'];
...
?>
		...
		<div class="fixed container">
			<a href="cart.php?login=<?php echo $_GET['login'];?>&store=<?php echo $_GET['id'];?>">	<button type="button" class="cart-items-btn">
					<div class="row">
						<div class="col-6">
							<span class="cart-name">Cart <span class="count-of-item">(<?php echo $qty;?> Items)</span></span>
						</div>
						<div class="col-6 text-right">
							<span class="cart-price">₱ <?php echo number_format($total,2);?></span>
						</div>
					</div>
							...
							<center>
							     ...
							     <?php
											  ...
											  ?>
											   	...
											   	<img id="product-image" class="product-image" alt="product image" src="../auth/users/products/<?php echo $row['prod_image'];?>" srcset="../auth/users/products/<?php echo $row['prod_image'];?>">
											    <?php
											  }else{
											  ?>
											     	<img id="product-image" class="product-image" alt="product image" src="noim.jpg">
									...
									<div class="col-12 col-sm-6 col-lg-6">
										<div class="slideshow-container">
											...
											<div class="mySlides2 fade">
											  ...
											  ?>
											   <img src="../auth/users/products/noim.jpg" style="width:100%">
											     <?php
											  }
											  ?>
											</div>
									...
									<div class="col-12 col-sm-12 col-lg-12 mt-1">
										<div class="row quantity-container">
											<div class="input-group col-6 col-sm-6 col-lg-6">
												...
												<input onClick="getAmount()" type="button" value="-" class="button-minus" data-quantity="minus" data-field="quantity">
												
												
												<input type="number"  id="myText[]" onkeyup="getAmount()" step="1" max="999" value="0" name="quantity" class="quantity-field">
												   
												<input onClick="getAmount()" type="button" value="+" class="button-plus" data-quantity="plus" data-field="quantity">
											</div>
