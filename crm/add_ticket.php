...
$ticket_no=$_POST['ticket_no'];
	$query21a1=mysqli_query($con,"select * from  ticket where ticket_no='$ticket_no' and user_id='$com' ")or die(mysqli_error());
...
$added_on=date("Y-m-d H:i");
		  ...
		  mysqli_query($con,"INSERT INTO ticket(type,title,message,date_added,user_id,ticket_no,status) VALUES('customer','$prod_image','$message','$added_on','$com','$ticket_no','Pending')")or die(mysqli_error($con));
...
?>
    ...
    window.setTimeout(function() {
        window.location.href='support.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
<?php
    ...
    <script type="text/javascript">
    window.setTimeout(function() {
       window.location.href='add_ticket.php?login='<?php echo $_GET['login'];?>;
    }, 1000);
</script>
...
swal("Ops!", "Ticket Already Sent!", "warning");
...
?>           
   ...
   <?php
	...
	$query21a1=mysqli_query($con,"select * from  ticket where ticket_rep=''")or die(mysqli_error());
$row21a1a=mysqli_num_rows($query21a1);
...
$number = sprintf('%08d',$number);
			...
			<div class="product-information-container">
				...
				<div class="row">
					<div class="col-12">
						<span class="enter-product-info-title">Ticket Information</span>
					</div>
					...
					<div class="col-12 mt-1">
						...
						<!-- <form action=""> -->
								...
								<input type="hidden" id="name" name="ticket_no" placeholder="Name" value="<?php echo $number;?>" readonly>
							</div>
				                                          
							<div class="mt-p5">
								<input type="text" id="name" name="title" placeholder="Subject" required>
							</div>
						<div class="mt-p5">
							...
							<div class="row reverse-order">
								...
								<div class="col-12 col-sm-12 col-lg-12 mt-1">
									<button name="signin" type="submit" class="add-product">Submit</button>
								</div>
							</div>
						</form>
