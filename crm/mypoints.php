...
?>
	...
	<span class="filter_by">Filter By:</span>
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected">Id Number (asc)</option>
				<option value="0_desc">Id Number (desc)</option>

				<option value="1_asc">User Name (asc)</option>
				<option value="1_desc">User Name (desc)</option>
				
								<option value="2_asc">Points (asc)</option>
				<option value="2_desc">Points (desc)</option>
...
$querycate2a2=mysqli_query($con,"select * from  customer  where id='$com' ")or die(mysqli_error());
$rowcateg2a2=mysqli_fetch_array($querycate2a2);

$cc=$rowcateg2a2['id_number'];
$query=mysqli_query($con,"select * from  pending_points where sponsor='$cc' and date_collected!=''")or die(mysqli_error());
...
$querycate2=mysqli_query($con,"select * from  customer  where id='$cat2' ")or die(mysqli_error());
$rowcateg2=mysqli_fetch_array($querycate2);


$cat2a=$row['user'];

$querycate2a=mysqli_query($con,"select * from  customer  where id_number='$cat2a' ")or die(mysqli_error());
$rowcateg2a=mysqli_fetch_array($querycate2a);


$querycate2as=mysqli_query($con,"select * from  customer  where id_number='$cat2a' ")or die(mysqli_error());
...
?>
	  <td><?php echo $rowcateg2as['firstname']?> <?php echo $rowcateg2as['lastname']?></td>  
<?php
}
?>
							<td> <?php echo number_format($row['points'],2)?></td> <!--Price-->
		...
		?>
								...
								<div class="row mt-1">
									<div class="col-12">
										...
										<div class="row mt-1">
								    	<div class="col-12">
										<span ><?php echo $rowcateg2a['firstname']?> <?php echo $rowcateg2a['lastname']?></span>
									</div>
									</div>
								...
								<div class="row mt-1">
									...
									<div class="col-12">
										<span class="name-inv"><?php echo number_format($row['points'],2)?></span>
									</div>
