	...
	<body>
		<div id="T_12_POS_Receipt-rev1">
			...
			<div class="row" style="margin-top: -4px;">
				...
				<div class="col-sm-3 col-12 pr-0-md" id="psc">
...
$total=0;
$query=mysqli_query($con,"select * from  temp_prod where user_id='$com' and invoice='$invoice' order by id asc")or die(mysqli_error());
...
$rowcateg=mysqli_fetch_array($querycate);
									...
									<div class="per-order">
										...
										<div class="row">
											...
											<div class="col-4 text-right pl-0-sm">
												<span class="amount">₱<?php echo $row['price']*$row['qty'];?></span>
											</div>
										</div>
		...
		<?php
		$cat2=$_GET['invoice'];
		$querycate=mysqli_query($con,"select * from  sales_crm  where invoice='$cat2'")or die(mysqli_error());
$rowcateg=mysqli_fetch_array($querycate);
