      ...
      <!--  <a  style="padding:10px" href="add_product.php?login=<?php echo $_GET['login'];?>" class="add-btn"><center><i class="fa fa-plus"></i> Add</center></a>-->
			...
			<select name="sortBy" id="sortBy">
				<option value="0_asc" selected="selected">Order ID (asc)</option>
						<option value="0_asc">ID (asc)</option>
				<option value="0_desc">ID (desc)</option>
				<option value="1_asc">Date Ordered (asc)</option>
				<option value="1_desc">Date Ordered (desc)</option>

				<option value="3_asc">Status (asc)</option>
				<option value="3_desc">Status (desc)</option>
			</select>
...
$query=mysqli_query($con,"select * from  sales_crm where user_id='$com' order by id asc")or die(mysqli_error());
while($row=mysqli_fetch_array($query)){  
				  ...
				  ?>  
						...
						<tr>
							<td class="per-inv-product-container">
								<div class="row">
									<div class="col-6">
									<a href="receipt_view2.php?id=<?php echo $row['id'];?>&login=<?php echo $_GET['login'];?>&cus=<?php echo $row['cust_id'];?>&invoice=<?php echo $row['invoice'];?>"  class="order_id"><?php echo $row['invoice']?></a> <!--Order ID-->
									</div>
									<div class="col-4">
								...
								<div class="row mt-1">
									<div class="col-6">
										<span class="name-inv">₱  <?php echo number_format($row['total'],2)?></span>
									</div>
								<div class="col-6">
										<span class="points-inv"><?php 
...
echo date_format($date,"M d, Y H:ia");
		...
		?></span>
								...
								<div class="row mt-1">
									<div class="col-6">
										<span class="points-inv"><?php echo $rowcateg2a['business_name']?></span>
									</div>
								<div class="col-6">
										<span class="points-inv"><?php 
				 echo $row['payment'];
