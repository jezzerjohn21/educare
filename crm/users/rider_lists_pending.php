              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Rider's Pending Application</h4>
                  </div>
                  <div class="card-body">
...
if($rowuser['type']==2){
$sp=$rowuser['id'];
$query=mysqli_query($con,"select * from  user where type='3' and sponsor_id='$sp' and status='Pending' order by lastname asc")or die(mysqli_error());

}else{
    
    $query=mysqli_query($con,"select * from  user where type='3' and status='Pending' order by lastname asc")or die(mysqli_error());
                          ...
                          <tr>
                            <td><?php echo $count?></td>
                                   ...
                                   ?>                                                                 
                                                                                                                            	   ...
                                                                                                                            	   <td><a href="edit_user_rider.php?id=<?php echo $row['id'];?>" class="btn btn-success">Update/View</a></td>
