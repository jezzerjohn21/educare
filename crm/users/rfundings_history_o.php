...
$si=$rowuser['id'];
$query=mysqli_query($con,"select * from  funding_history where type='Rider' and transfer_by='$si' order by id asc")or die(mysqli_error());
