...
$query=mysqli_query($con,"select * from  withdrawals where user_id='$is' order by id asc")or die(mysqli_error());
                                      ...
                                      <td><?php echo strtoupper($rows['lastname'])?>, <?php echo strtoupper($rows['firstname'])?> <?php echo strtoupper($rows['middlename'])?></td>
                                             <td><?php echo $row['bank_name']?></td>  
                                                    ...
                                                    <td><?php echo number_format($row['amount'],2)?></td>
                                                      <td><?php echo number_format($row['tf'],2)?></td>
                                                       <td><?php echo number_format($row['vat'],2)?></td>
                                                      <td><?php echo number_format($row['amount_final'],2)?></td>
