              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Unused Operator Code Lists</h4>
                  </div>
                  <div class="card-body">
...
$query=mysqli_query($con,"select * from  code where operator_id='0' order by id asc")or die(mysqli_error());
				  ...
				  ?> 
                          ...
                          <tr>
                            <td><?php echo $count?></td>
                                      ...
                                      <td>       <span class="badge badge-primary"><?php echo $row['code']?></span></td>
                                          <td>
                                               <span class="badge badge-primary"><?php echo $row['pin']?></span>
                                ...
                                ?>
                                     <td><?php echo $row['remarks']?></td>
                                                   <td><?php echo strtoupper($row2['lastname'])?>, <?php echo strtoupper($row2['firstname'])?> <?php echo strtoupper($row2['middlename'])?></td>
                                                                                                                            	   ...
                                                                                                                            	   <td><a href="code_remarks.php?id=<?php echo $row['id'];?>" class="btn btn-success">Remarks</a></td>
