              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Operator's Funding History</h4>
                  </div>
                  <div class="card-body">
...
$si=$rowuser['id'];
$query=mysqli_query($con,"select * from  funding_history where type='Operator' and transfer_by='$si' || type='Operator' and user_id='$si'order by id asc")or die(mysqli_error());
